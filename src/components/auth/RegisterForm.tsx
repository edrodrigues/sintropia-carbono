...
export function RegisterForm({ error: initialError }: RegisterFormProps) {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        router.push('/login?message=Cadastro realizado! Verifique seu e-mail para confirmar a conta.');
    };
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="space-y-4">
                ...
                <div className="relative my-4">
                    ...
                    <div className="relative flex justify-center text-[10px] uppercase">
                        <span className="bg-white dark:bg-gray-900 px-3 text-gray-500 font-bold tracking-widest">ou com email</span>
                    </div>
                </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                >
                    {loading ? 'Criando conta...' : 'Criar Conta Grátis (~30 segundos)'}
                </button>
