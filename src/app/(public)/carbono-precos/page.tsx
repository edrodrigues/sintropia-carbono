        ...
        <>
            ...
            <main className="max-w-7xl mx-auto px-8 lg:px-16 py-12">
                ...
                <div className="bg-gradient-to-r from-green-50 to-blue-50 dark:from-green-900/20 dark:to-blue-900/20 rounded-xl p-6 mb-8 border border-gray-200 dark:border-gray-700">
                    <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-4">📊 SUMÁRIO EXECUTIVO</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        {[
                            { label: "Mercado LatAm", value: "USD $63.05B", sub: "2025 → $824B (2034)", color: "text-[#1e40af]" },
                            { label: "EU ETS", value: "€60-80", sub: "/tCO2e", color: "text-green-600" },
                            { label: "VCM Global", value: "$3.50-14.80", sub: "/tCO2e por qualidade", color: "text-orange-600" },
                            { label: "⚠️ VCM Colômbia", value: "Queda 70%+", sub: "Crise de preços REDD+", color: "text-red-600" }
                        ].map((item, i) => (
