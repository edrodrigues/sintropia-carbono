    ...
    <>
      ...
      <main className="max-w-7xl mx-auto px-8 lg:px-16 py-12">
        ...
        <div className="bg-indigo-50 dark:bg-indigo-900/20 p-6 rounded-xl border border-indigo-200 dark:border-indigo-800">
          <h3 className="text-lg font-bold text-indigo-900 dark:text-indigo-200 mb-4">
            📈
            {t("projection")}
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            <div className="bg-white dark:bg-gray-800 p-4 rounded-xl shadow-inner border border-indigo-100">
              ...
              <div className="space-y-2">
                <div className="flex justify-between text-xs border-b border-gray-50 dark:border-gray-700 pb-1">
                  <span>{tDrivers("re100")}</span>
                  <span className="font-bold text-green-600">Alto</span>
                </div>
                <div className="flex justify-between text-xs border-b border-gray-50 dark:border-gray-700 pb-1">
                  <span>{tDrivers("scarcity")}</span>
                  <span className="font-bold text-orange-600">Médio</span>
                </div>
