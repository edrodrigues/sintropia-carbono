...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  const titles: Record<string, string> = {
    pt: "Ranking Carbono Brasil 2025 | Maiores Empresas por Setor",
    en: "Carbon Brazil Ranking 2025 | Largest Companies by Sector"
  };
  
  const descriptions: Record<string, string> = {
    pt: "Top 20 empresas brasileiras que mais compensam carbono por setor. Banco Votorantim, Petrobras, Suzano e Vale lideram o mercado brasileiro de créditos de carbono.",
    en: "Top 20 Brazilian companies that offset the most carbon by sector. Banco Votorantim, Petrobras, Suzano and Vale lead the Brazilian carbon credit market."
  };
  ...
  return {
    ...
    keywords: locale === "pt" 
      ? ["carbono Brasil", "créditos de carbono Brasil", "empresas carbono", "ranking carbono", "compensação carbono", "tCO2e Brasil"]
      : ["carbon Brazil", "carbon credits Brazil", "carbon companies", "carbon ranking", "carbon offset", "tCO2e Brazil"],
    alternates: {
      canonical: `https://sintropia.space/${locale === 'pt' ? '' : locale + '/' }carbono-brasil`,
    },
  };
}
