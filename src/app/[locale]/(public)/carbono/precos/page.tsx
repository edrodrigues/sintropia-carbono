              ...
              <div className="border border-gray-200 dark:border-gray-700 rounded-xl p-4">
                ...
                <ul className="space-y-2 text-sm">
                  <li className="flex justify-between">
                    <span>REDD+ (Alta Qualidade)</span>
                    <span className="font-mono font-bold text-emerald-600">$12-18</span>
                  </li>
                  <li className="flex justify-between">
                    <span>Restauração Nativa (ARR)</span>
                    <span className="font-mono font-bold text-emerald-600">$15-25</span>
                  </li>
                  <li className="flex justify-between">
                    <span>Mangues (Blue Carbon)</span>
                    <span className="font-mono font-bold text-emerald-600">$20-30</span>
                  </li>
                </ul>
              </div>
              <div className="border border-gray-200 dark:border-gray-700 rounded-xl p-4">
                ...
                <ul className="space-y-2 text-sm">
                  <li className="flex justify-between">
                    <span>Fogões Eficientes</span>
                    <span className="font-mono font-bold text-blue-600">$4-8</span>
                  </li>
                  <li className="flex justify-between">
                    <span>Captura de Metano</span>
                    <span className="font-mono font-bold text-blue-600">$6-12</span>
                  </li>
                  <li className="flex justify-between">
                    <span>Biochar</span>
                    <span className="font-mono font-bold text-blue-600">$100-200</span>
                  </li>
                </ul>
              </div>
            </div>
