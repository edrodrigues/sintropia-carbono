...
export default async function TermosPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const tSec = await getTranslations({ locale, namespace: "Termos.sections" });
  const tLinks = await getTranslations({ locale, namespace: "Termos.footerLinks" });

  const sections = [
    { key: "1", title: tSec("1.title"), content: tSec("1.content") },
    { key: "2", title: tSec("2.title"), content: tSec("2.content"), list: [tSec("2.list.0"), tSec("2.list.1"), tSec("2.list.2"), tSec("2.list.3")], footer: tSec("2.footer") },
    ...
    { key: "5", title: tSec("5.title"), content: tSec("5.content"), list: [tSec("5.list.0"), tSec("5.list.1"), tSec("5.list.2"), tSec("5.list.3"), tSec("5.list.4"), tSec("5.list.5")] },
    { key: "6", title: tSec("6.title"), content: tSec("6.content"), list: [tSec("6.list.0"), tSec("6.list.1"), tSec("6.list.2")] },
    { key: "7", title: tSec("7.title"), content: tSec("7.content") },
    { key: "8", title: tSec("8.title"), content: tSec("8.content") },
    { key: "9", title: tSec("9.title"), content: tSec("9.content"), list: [tSec("9.list.0"), tSec("9.list.1"), tSec("9.list.2"), tSec("9.list.3")] },
    { key: "10", title: tSec("10.title"), content: tSec("10.content") },
    { key: "11", title: tSec("11.title"), content: tSec("11.content") },
    { key: "12", title: tSec("12.title"), content: tSec("12.content"), button: tSec("12.button") },
  ];
    ...
    <>
        ...
        <div className="max-w-7xl mx-auto px-8 lg:px-16">
          <div className="flex justify-between items-center h-20">
            <Link href="/" className="flex items-center gap-3">
              ...
              <div>
                <h1 className="font-bold text-xl text-deep-forest dark:text-electric-emerald leading-tight">
                  Sintropia
                </h1>
              </div>
            </Link>
      ...
      <main className="max-w-4xl mx-auto px-8 lg:px-16 py-16">
        <div className="text-center mb-12">
          <span className="inline-block px-4 py-2 bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-electric-emerald rounded-full text-sm font-bold mb-4">
            📄
            {" "}
            {t("heroBadge")}
          </span>
        ...
        {sections.map(section => (
          <div key={section.key} className="bg-white dark:bg-gray-800 p-8 rounded-2xl border border-gray-200 dark:border-gray-700 mb-8">
            ...
            {section.key === "12" && section.button && (
              <a
                href="https://github.com/edrodrigues/sintropia-carbono/issues"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 text-deep-forest dark:text-electric-emerald font-bold hover:underline"
              >
                {section.button}
        ...
        <div className="max-w-7xl mx-auto px-8 lg:px-16 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-4">
              <Link
                href="/privacidade"
                className="text-sm text-gray-500 dark:text-gray-500 hover:text-deep-forest dark:hover:text-blue-400 transition-colors"
              >
                {tLinks("privacidade")}
              </Link>
              <Link
