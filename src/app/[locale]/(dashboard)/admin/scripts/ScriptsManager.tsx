    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
      ...
      <div className="lg:col-span-2 space-y-6">
        ...
        <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 flex items-start gap-3 dark:bg-amber-900/10 dark:border-amber-900/30">
          <svg className="w-5 h-5 text-amber-600 mt-0.5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div>
            ...
            <p className="text-xs text-amber-700 dark:text-amber-300 mt-0.5">
              Estes scripts têm acesso direto ao banco de dados e à API do Resend. Use com cautela e sempre teste com
              {" "}
              <code className="bg-amber-100 dark:bg-amber-900/40 px-1 rounded text-amber-900 dark:text-amber-100">--dry-run</code>
              {" "}
              quando disponível antes de realizar ações reais.
            </p>
          </div>
        </div>
      </div>
